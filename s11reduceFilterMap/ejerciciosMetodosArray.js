...
const nationFilter = ((usersList,countryInitials) =>{
  let result = usersList.filter((user) => user.nat === countryInitials)
  return result;
})
...
op2= "IE"
op3= "DK"
console.log(nationFilter(users,op1))
console.log(nationFilter(users,op2))
console.log(nationFilter(users,op3))

/*
2.- Necesito obtener una lista de los países disponibles sin repetir
*/

const countryList = ((users)=>{
...
console.log(countryList(users))


/*
3.- Necesito obtener una lista de usuarios por género
*/
const genderList = ((usersList,gender) =>{
  let result = usersList.filter((user)=> user.gender === gender)
  return result
})

console.log (genderList(users,"female"))
console.log (genderList(users,"male"))
